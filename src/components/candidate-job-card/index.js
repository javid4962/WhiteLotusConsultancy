    ...
    <Fragment>
      ...
      >
        <CommonCard
          ...
          footerContent={
            <Button
              ...
              className=" dark:bg-[#fffa27] flex h-21 items-center justify-center px-5"
            >
              View Details
            </Button>
          }
        ...
        <DrawerContent className="p-6 ">
          ...
          <div className="flex gap-5 mt-6 "> <h3 className="text-2xl font-medium text-black mt-3">Skills:</h3> 
            {jobItem?.skills.split(",").map((skillItem) => (
              <div className="w-[150px] flex justify-center items-center h-[65px] dark:bg-white  bg-black rounded-[4px] p-5">
